package com.example.lab3umairah2nd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                db.execSQL("insert into biodata(no, name, dob, gender, address) values ('" + text1.getText().toString() + "','" + text2.getText().toString() + "','" + text3.getText().toString() +
